...
from blog_v2.views import ArticleListView, ArticleDetailView, AuthorListView, AuthorDetailView, DraftListView, AuthorDraftDetailView, TagListView, TagDetailView
from . import views

app_name='blog_v2'
urlpatterns = [
    path('test/', views.test, name='test'),
    path('', RedirectView.as_view(pattern_name='blog_v2:articles'), name='home_page'),
